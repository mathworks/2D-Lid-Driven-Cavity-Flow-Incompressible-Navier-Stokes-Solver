...
The low-storage third-order semi-implicit Runge�黑utta method of Spalart et al. (1991)[3] is also implemented for the temporal discretization to achieve a higher order of temporal accuracy. See `updateVelocityField_RK3.m`. The equations to be solved at each step then become
